...
export default function PrivacyPage() {
  return (
    <article className="max-w-3xl">
      <h1 className="font-display text-3xl text-slate-900">Política de privacidad</h1>
      <p className="mt-2 text-sm text-slate-500">Última actualización: junio 2026</p>

      <div className="mt-8 space-y-6 text-slate-700 leading-relaxed">
        <section>
          <h2 className="font-semibold text-slate-900">1. Responsable</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-slate-900">2. Datos que recopilamos</h2>
        ...
        <section>
          <h2 className="font-semibold text-slate-900">3. Uso de la información</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-slate-900">4. Compartición con terceros</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-slate-900">5. Tus derechos</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-semibold text-slate-900">6. Seguridad</h2>
          <p className="mt-2">
